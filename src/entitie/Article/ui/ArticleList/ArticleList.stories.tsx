...
export default {
    title: 'entitie/Article/ArticleList',
...
const article = {
    ...
    img: 'https://cdn.pixabay.com/photo/2024/03/11/10/45/boy-8626374_1280.jpg',
    views: 1022,
...
export const IsLoadingBigNormal = Template.bind({});
IsLoadingBigNormal.args = {
    isLoading: true,
...
IsLoadingBigNormal.decorators = [
    StoreDecorator({}),
];

export const IsLoadingSmallNormal = Template.bind({});
IsLoadingSmallNormal.args = {
    isLoading: true,
...
IsLoadingSmallNormal.decorators = [
    StoreDecorator({}),
];
